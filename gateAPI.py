...
from HttpUtil import getSign, httpGet, httpPost , httpGetCandle
...
class GateIO:
    ...
    # 单项交易对市场深度
    def candlestick(self, current_pair,GROUP_SEC,RANGE_HOUR):
        URL = "/api2/1/candlestick2"
        return httpGetCandle(self.__url, URL,current_pair,GROUP_SEC,RANGE_HOUR)
