...
def wave():
    ...
    while delt < 5000 and delt > -5000:
        try:
            ...
            print('----------------------------------------------------------')
            # 测试区-------------------------------------------------
            print(1 / float(mytickers['HOTETH']['ask']) * 0.999 * float(mytickers['HOTBTC']['ask']) * 0.999 / float(
                mytickers['ETHBTC']['bid']) * 0.999)
            ...
            profit = float(mybalance['ETH']['free']) + float(mybalance['ETH']['locked']) + (
                        float(mybalance['HOT']['free']) + float(mybalance['HOT']['locked'])-204000) * float(
...
#set API key
set("NeOj0CzIimfwKWDtPYpKn6U1A4hLRm8lpRJlQxE4ToHQtKpJ3AgWcKxFWFW4Czj5","tLSUvOE1oNi7fUEdy7CUlShyLhW2fmBMP6wNboI2lmRP1N3jkdwSA3x3YaAVZsFK")
