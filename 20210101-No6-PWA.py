...
if __name__ == "__main__":
    exchangeNames=['Binance','Bitmax','Pwang','Hoo','Huobi','GateIO'] 
    pairs_all = []
    data_all = []
    pairs_new =[[] for i in exchangeNames]
    delete_coins=[['ETC'],[],['MPH','ETC','COVER','SWINGBY','OM'],['COVER','BOND','AGS','ATP','CET','ETC','OM','BAS'],['HOT','3L','3S','ETC'],['RAMP','COVER','CET','ETC','BCHA']]
